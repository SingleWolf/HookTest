...
public class ReflexUtils {
    ...
    public static Object getFieldObject(String className, Object obj, String filedName) {
        try {
            ...
            Log.e(AmsHookHelperUtils.TAG,filedName+" don't found in "+className+" and error is "+e.toString());
            e.printStackTrace();
        }
        return null;
    }
    ...
    public static Object getFieldObject(Class clazz, Object obj, String filedName) {
        try {
            ...
            Log.e(AmsHookHelperUtils.TAG,filedName+" don't found in "+clazz.getName());
            e.printStackTrace();
        }
    ...
    public static void setFieldObject(Class clazz, Object obj, String filedName, Object filedVaule) {
        try {
            ...
            Log.e(AmsHookHelperUtils.TAG,filedVaule+" don't set in "+filedName);
            e.printStackTrace();
        }
    }
